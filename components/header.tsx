...
const Header = () => {
    ...
    return (
        <div className='h-16 sticky z-50 top-4 shadow-md bg-transparent backdrop-blur shadow-gray-700 w-[90%] mt-2 px-8 sm:px-12 rounded-full mx-auto flex justify-between items-center'>
